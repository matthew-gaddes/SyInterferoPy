function [ux,uy,uz,err] = dc3d3(alpha,x,y,depth,dip,al1,al2,aw1,aw2,disl1,disl2,disl3) 
%% function [ux,uy,uz,err] = dc3d3(alpha,x,y,depth,dip,al1,al2,aw1,aw2,disl1,disl2,disl3)
%%
...
%% added source depth back in so can do sills: tjw 12 aug 09
...
%                                %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
     z = 0; % note that this version only works for z = 0, i.e. surface defo
     d = depth + z;
     p=y*c0_cd + d*c0_sd;
     q=y*c0_sd - d*c0_cd;
